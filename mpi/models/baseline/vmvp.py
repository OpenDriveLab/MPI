...
from mpi.models.util.transformer import Block, PatchEmbed, get_2D_position_embeddings
...
class VMVP(nn.Module):
    ...
    def get_representations(self, img: torch.Tensor, mode: str = "patch") -> torch.Tensor:
        ...
        # return representations#.mean(dim=1, keepdim=True)
    ...
    def encode(self, img: torch.Tensor) -> torch.Tensor:
        ...
        cls_patches = torch.cat([cls_tokens, patches], dim=1) + self.encoder_pe
