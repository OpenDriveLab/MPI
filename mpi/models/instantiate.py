...
from mpi.configs import DatasetConfig, ModelConfig

from .baseline.vcond import VCond
from .baseline.vdual import VDual
from .baseline.vgen import VGen
from .baseline.vmvp import VMVP
from .baseline.vr3m import VR3M
from .baseline.vrn3m import VRN3M
from .mpi_model import MPI
...
def get_model_optimizer(
    ...
    if model_cfg.identifier == "mpi-small" or model_cfg.identifier == "mpi-base":
        model = MPI(
